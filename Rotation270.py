...
class Rotation:
    ...
    def __init__(self, channel, min_theta, max_theta, init_theta=0):
        ...
        # 计算最小角度、最大角度的占空比
        self.min_dutycycle = 2.5 + self.min_theta * 10 / 270
        self.max_dutycycle = 2.5 + self.max_theta * 10 / 270
    ...
    def setup(self):
        ...
        self.dutycycle = 2.5 + self.init_theta * 10 / 270  # 脉冲占空比的初始值
    ...
    def positiveRotation(self):
        ...
        """
        self.dutycycle = self.dutycycle + Rotation.delta_theta * 10 / 270
    ...
    def specifyRotation(self, theta):
        ...
        转动到指定的角度
        """
        if theta < 0 or theta > 270:
            return
        self.dutycycle = 2.5 + theta * 10 / 270
        self.pwm.ChangeDutyCycle(self.dutycycle)
        time.sleep(Rotation.max_delay)
